<?php
    ...
    class User {
        ...
        public $username;
        // protected means that any class that inherit this base class
        // will also have the property (privately)
        // while private means that any class that inherit this base class
        // will not have the right to use the property
        protected $email;
        public $role = "member";
